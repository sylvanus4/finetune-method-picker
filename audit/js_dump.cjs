...
const cfgs = [
  ...
  { tuning: "lora_8bit", numGpus: 1, perDeviceBatch: 1, gradAccum: 16, seqLen: 2048, gradCkpt: true, optimizer: "adamw_8bit", loraR: 16, targetModules: "all", datasetExamples: 3000, avgTokensPerExample: 768, epochs: 2, mfu: 0.35 },
];
const out = [];
